...
const fetchBooks = async () => {
  ...
  // console.log(result.data.book.selfLink);
              ...
              <li key={index}>
                <div>
                  ...
                  <div>
                    ...
                    <h3>{book.volumeInfo.authors}</h3>{/* authors  */}
                    <h3>{book.volumeInfo.description}</h3>{/* description */}
                    <h3>{book.volumeInfo.image}</h3>{/* image */}
